    ...
    <section className=" mx-auto max-w-7xl lg:px-9 md:px-5 px-3 my-8 mt-28 ">
      ...
      <div className="max-w-5xl mx-auto mt-10">
        ...
        <p className="my-2 font-medium text-sm">
          Thank you for contacting <q>WhereIsIt</q>. We strive to answer most
          enquiries within 24 hours.
        </p>
        <h2 className="font-semibold mt-4 text-[#003366]">How to contact</h2>
        <p className=" text-sm">
          Simply fill-in the form below and click Send. Please check and enter
          the required information accurately. Thanks again for contacting us.
        </p>
        <p className="font-semibold my-2 text-sm">Best Regards,</p>
        <p className="font-semibold my-2 text-sm">WhereIsIt,</p>

        <form className="space-y-4  bg-[#0033662a] py-11 px-4 rounded-md ">
          <div>
